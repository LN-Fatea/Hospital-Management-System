...
urlpatterns = [
    ...
    path('volunteerlogin', LoginView.as_view(template_name='hospital/volunteerlogin.html')),
    ...
    path('delete-volunteer-from-hospital/<int:pk>', views.delete_volunteer_from_hospital_view, name='delete-volunteer-from-hospital'),
    ...
    path('admin-approve-volunteer', views.admin_approve_volunteer_view, name='admin-approve-volunteer'),
...
urlpatterns +=[
    ...
    path('diagnose-patient/<int:pk>', views.diagnose_patient, name='diagnose-patient'),
...
#---------FOR VOLUNTEER RELATED URLS-------------------------------------
urlpatterns +=[
    path('volunteer-dashboard', views.volunteer_dashboard_view, name='volunteer-dashboard'),
    path('volunteer-schedule', views.volunteer_schedule_view, name='volunteer-schedule'),
    path('volunteer-tasks', views.volunteer_tasks_view, name='volunteer-tasks'),
]
